...
void controlMotor(int pwmPin, int dirPin, float speed) {
  ...
  analogWrite(pwmPin, abs(pwm)); //abs(pwm)
}
...
void loop() {
  ...
  if (Serial.available() >= sizeof(SwerveData)) {
    ...
    Serial.print("Motors: ");
    Serial.print(nextData.motor1); Serial.print(", ");
    Serial.print(nextData.motor2); Serial.print(", ");
    Serial.print(nextData.motor3); Serial.print(", ");
    Serial.println(nextData.motor4);

    Serial.print("Servos: ");
    Serial.print(nextData.servo1); Serial.print(", ");
    Serial.print(nextData.servo2); Serial.print(", ");
    Serial.print(nextData.servo3); Serial.print(", ");
    Serial.println(nextData.servo4);

    Serial.print("Checksum: ");
    Serial.println(nextData.checksum);
    Serial.println("------------------------------");*/
